...
export const SocialCard: FC<SocialCardProps> = ({
  ...
  return (
    <Link className="group" href={href} target="_blank">
      <div className="flex flex-col flere justify-between sm:w-[235px] w-[157px] sm:h-[328px] h-[146px] sm:p-[25px] p-5 border border-white/10 rounded-[10px] backdrop-blur-3xl hover:bg-[#FF3B00] transition-colors duration-500">
        <div className="flex justify-between items-center">
          <div>
            <Image src={icon} alt="icon" width={23} height={23} className="sm:w-[23px] w-[15px]" />
          </div>
          <div className="sm:w-[28px] w-[18px] sm:h-[28px] h-[18px] flex items-center justify-center border border-white/10 group-hover:border-black rounded-[5px] transition-colors duration-500">
            <Image src={right} alt="right" width={10} height={13} className="sm:w-[10px] w-[5px] group-hover:invert group-hover:-rotate-90 transition-all duration-400"/>
          </div>
        </div>
