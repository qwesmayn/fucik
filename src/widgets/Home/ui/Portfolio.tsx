...
export const Portfolio: FC<PortfolioProps> = ({ projects }) => {
  return (
    <section
      id="portfolio"
      className="relative sm:mb-[150px] mb-[37px] sm:min-h-screen sm:max-h-[1974px] xl:px-15 px-5 pb-[50px]"
    >
      ...
      <div className="absolute z-50 md:-bottom-12 left-0 w-full flex justify-center sm:px-15 px-5">
        <Link
